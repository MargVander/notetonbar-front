  ...
  <ion-content>
    <ion-list>
      <ion-item lines="none" v-for="bar in data" :key="bar.id">
        <ion-card>
          <div v-if="!bar.pictures[0]" class="card-img" style="background-image: url(https://img.phonandroid.com/2020/09/clients-bar.jpg)" />
          <div v-if="bar.pictures[0]" class="card-img" v-bind:style="{ backgroundImage: 'url(http://localhost:3000/pictures/' + bar.pictures[0].path + ')' }"/>
